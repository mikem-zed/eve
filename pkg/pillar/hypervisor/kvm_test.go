...
func TestCreateDom(t *testing.T) {
	...
	os.WriteFile(conf.Name(), []byte(`# This file is automatically generated by domainmgr
[msg]
  timestamp = "on"
...
func TestCreateDomConfigForMultifunctionDevice(t *testing.T) {
	initTest(t)
	id, err := uuid.NewV4()
	if err != nil {
		t.Errorf("NewV4 failed: %v", err)
...
func TestCreateDomConfigFotTheSameAssignmentGroup(t *testing.T) {
	initTest(t)
	id, err := uuid.NewV4()
	if err != nil {
		t.Errorf("NewV4 failed: %v", err)
